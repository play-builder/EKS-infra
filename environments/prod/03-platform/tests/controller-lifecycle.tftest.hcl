...
run "prod_baseline_has_no_load_controller" {
  ...
  assert {
    ...
    error_message = "Prod baseline must not install the platform load controller."
  }
}
...
override_data {
  ...
  values = { outputs = { vpc_id = "vpc-0123456789abcdef0", logging_contract = {
    ...
    aws_region   = "ap-northeast-2"
    log_group_names = {
      control_plane = "/aws/eks/prod-mini-commerce/cluster"
      vpc_flow      = "/aws/vpc/prod-playdevops/flow-logs"
      application   = "/aws/containerinsights/prod-mini-commerce/application"
      performance   = "/aws/containerinsights/prod-mini-commerce/performance"
    ...
    control_plane = { arn = "arn:aws:logs:ap-northeast-2:123456789012:log-group:/aws/eks/prod-mini-commerce/cluster", retention_days = 90, kms_key_arn = "arn:aws:kms:ap-northeast-2:123456789012:key/11111111-2222-3333-4444-555555555555" }
...
override_data {
  ...
  values = { outputs = {
    cluster_name                       = "prod-mini-commerce"
    cluster_arn                        = "arn:aws:eks:ap-northeast-2:123456789012:cluster/prod-mini-commerce"
