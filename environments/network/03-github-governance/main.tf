# GitHub governance for the GitOps repository: merge settings, vulnerability alerts, main-protection ruleset.
# State lives in the network account bucket; the GitHub provider authenticates with GITHUB_TOKEN.
