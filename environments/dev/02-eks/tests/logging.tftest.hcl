...
run "existing_cluster_log_group_consumes_network_key" {
  command = plan
  assert {
    condition     = output.audit_log_groups.control_plane.kms_key_arn == "arn:aws:kms:ap-northeast-2:123456789012:key/11111111-2222-3333-4444-555555555555" && output.audit_log_groups.control_plane.retention_days == 7
