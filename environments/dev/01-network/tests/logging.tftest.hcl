...
run "five_log_names_and_flow_group_share_owned_key" {
  ...
  assert {
    ...
    }.log_group_names && output.logging_contract.kms_key_arn == "arn:aws:kms:ap-northeast-2:123456789012:key/11111111-2222-3333-4444-555555555555" && output.audit_log_groups.vpc_flow.kms_key_arn == "arn:aws:kms:ap-northeast-2:123456789012:key/11111111-2222-3333-4444-555555555555" && output.audit_log_groups.vpc_flow.retention_days == 30
